...
// ------------------------------------------------------------------------------------------------
namespace HairMaxCustomizations.Manufacturing.Reports;
...
report 52605 "HMX Planning Availability"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SRC/RDL/PlanningAvailability.rdl';
    ...
    dataset
    {
        dataitem(TopLevel; Integer)
        {
            ...
            dataitem("Assembly Header"; "Assembly Header")
            {
                ...
                var
                    recordid: Record "Record Link";
                begin
                    if SelectionReq then begin
                        NewRecordWithDetails("Due Date", "Item No.", Description);
                        TempPlanningBuffer."Document Type" := TempPlanningBuffer."Document Type"::"Assembly Order";
                        TempPlanningBuffer."Document No." := "No.";
                        TempPlanningBuffer."Gross Requirement" := "Remaining Quantity";
                        ...
                        if TempPlanningBuffer.Find('-') then begin
                            TempPlanningBuffer."Gross Requirement" := TempPlanningBuffer."Gross Requirement" + "Remaining Quantity";
                    ...
                    //   ModifyForecast("Item No.", "Due Date", TempPlanningBuffer."Document Type"::"Assembly Order", "Remaining Quantity");
                end;
            }
            dataitem("Assembly Line"; "Assembly Line")
            {
                ...
                begin
                    if SelectionReq then begin
                        NewRecordWithDetails("Due Date", "No.", Description);
                        TempPlanningBuffer."Document Type" := TempPlanningBuffer."Document Type"::"Assembly Order Line";
                    ...
                    //     ModifyForecast("No.", "Due Date", TempPlanningBuffer."Document Type"::"Assembly Order Line", "Remaining Quantity");
                end;
            }
